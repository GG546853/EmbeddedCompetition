...
static void event_handler_cb_page_main_c1(lv_event_t *e) {
    ...
    if (event == LV_EVENT_CLICKED) {
        e->user_data = (void *)0;
        flowPropagateValueLVGLEvent(flowState, 80, 0, e);
    }
}
...
static void event_handler_cb_page_main_c1_2(lv_event_t *e) {
    ...
    if (event == LV_EVENT_CLICKED) {
        e->user_data = (void *)0;
        flowPropagateValueLVGLEvent(flowState, 110, 0, e);
    }
}
...
static void event_handler_cb_page_main_c1_4(lv_event_t *e) {
    ...
    if (event == LV_EVENT_CLICKED) {
        e->user_data = (void *)0;
        flowPropagateValueLVGLEvent(flowState, 140, 0, e);
    }
}
...
static void event_handler_cb_page_main_c1_39(lv_event_t *e) {
    ...
    if (event == LV_EVENT_CLICKED) {
        e->user_data = (void *)0;
        flowPropagateValueLVGLEvent(flowState, 155, 0, e);
    }
}
...
static void event_handler_cb_page_main_c1_40(lv_event_t *e) {
    ...
    if (event == LV_EVENT_CLICKED) {
        e->user_data = (void *)0;
        flowPropagateValueLVGLEvent(flowState, 170, 0, e);
    }
}
...
static void event_handler_cb_page_main_c1_41(lv_event_t *e) {
    ...
    if (event == LV_EVENT_CLICKED) {
        e->user_data = (void *)0;
        flowPropagateValueLVGLEvent(flowState, 185, 0, e);
    }
}
...
static void event_handler_cb_page_main_c29(lv_event_t *e) {
    ...
    if (event == LV_EVENT_CLICKED) {
        e->user_data = (void *)0;
        flowPropagateValueLVGLEvent(flowState, 200, 0, e);
    }
}
...
static void event_handler_cb_page_main_c30(lv_event_t *e) {
    ...
    if (event == LV_EVENT_CLICKED) {
        e->user_data = (void *)0;
        flowPropagateValueLVGLEvent(flowState, 215, 0, e);
    }
}
...
static void event_handler_cb_page_main_obj110(lv_event_t *e) {
    ...
    if (event == LV_EVENT_VALUE_CHANGED) {
        ...
        if (tick_value_change_obj != ta) {
            ...
            assignIntegerProperty(flowState, 231, 3, value, "Failed to assign Value in Slider widget");
        }
    }
}
...
static void event_handler_cb_page_main_obj177(lv_event_t *e) {
    ...
    if (event == LV_EVENT_CLICKED) {
        e->user_data = (void *)0;
        flowPropagateValueLVGLEvent(flowState, 361, 0, e);
    }
}
...
static void event_handler_cb_page_main_obj189(lv_event_t *e) {
    ...
    if (event == LV_EVENT_CLICKED) {
        e->user_data = (void *)0;
        flowPropagateValueLVGLEvent(flowState, 374, 0, e);
    }
}
...
static void event_handler_cb_page_main_obj191(lv_event_t *e) {
    ...
    if (event == LV_EVENT_CLICKED) {
        e->user_data = (void *)0;
        flowPropagateValueLVGLEvent(flowState, 376, 0, e);
    }
}
...
void tick_screen_page_main() {
    ...
    {
        const char *new_val = evalTextProperty(flowState, 59, 3, "Failed to evaluate Text in Label widget");
    ...
    {
        const char *new_val = evalTextProperty(flowState, 71, 4, "Failed to evaluate Text in Label widget");
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 71, 3, "Failed to evaluate Hidden flag");
        bool cur_val = lv_obj_has_flag(objects.obj208, LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj208;
            if (new_val) {
                lv_obj_add_flag(objects.obj208, LV_OBJ_FLAG_HIDDEN);
            } else {
                lv_obj_remove_flag(objects.obj208, LV_OBJ_FLAG_HIDDEN);
            }
            tick_value_change_obj = NULL;
        }
    }
    ...
    {
        int32_t new_val = evalIntegerProperty(flowState, 89, 3, "Failed to evaluate Max in Bar widget");
    ...
    {
        int32_t new_val = evalIntegerProperty(flowState, 89, 4, "Failed to evaluate Value in Bar widget");
    ...
    {
        int32_t new_val = evalIntegerProperty(flowState, 104, 3, "Failed to evaluate Max in Bar widget");
    ...
    {
        int32_t new_val = evalIntegerProperty(flowState, 104, 4, "Failed to evaluate Value in Bar widget");
    ...
    {
        int32_t new_val = evalIntegerProperty(flowState, 119, 3, "Failed to evaluate Max in Bar widget");
    ...
    {
        int32_t new_val = evalIntegerProperty(flowState, 119, 4, "Failed to evaluate Value in Bar widget");
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 124, 3, "Failed to evaluate Hidden flag");
    ...
    {
        const char *new_val = evalTextProperty(flowState, 130, 3, "Failed to evaluate Text in Label widget");
    ...
    {
        const char *new_val = evalTextProperty(flowState, 131, 3, "Failed to evaluate Text in Label widget");
    ...
    {
        int32_t new_val = evalIntegerProperty(flowState, 134, 3, "Failed to evaluate Max in Bar widget");
    ...
    {
        int32_t new_val = evalIntegerProperty(flowState, 134, 4, "Failed to evaluate Value in Bar widget");
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 139, 3, "Failed to evaluate Hidden flag");
    ...
    {
        const char *new_val = evalTextProperty(flowState, 145, 3, "Failed to evaluate Text in Label widget");
    ...
    {
        const char *new_val = evalTextProperty(flowState, 146, 3, "Failed to evaluate Text in Label widget");
    ...
    {
        int32_t new_val = evalIntegerProperty(flowState, 149, 3, "Failed to evaluate Max in Bar widget");
    ...
    {
        int32_t new_val = evalIntegerProperty(flowState, 149, 4, "Failed to evaluate Value in Bar widget");
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 154, 3, "Failed to evaluate Hidden flag");
    ...
    {
        const char *new_val = evalTextProperty(flowState, 160, 3, "Failed to evaluate Text in Label widget");
    ...
    {
        const char *new_val = evalTextProperty(flowState, 161, 3, "Failed to evaluate Text in Label widget");
    ...
    {
        int32_t new_val = evalIntegerProperty(flowState, 164, 3, "Failed to evaluate Max in Bar widget");
    ...
    {
        int32_t new_val = evalIntegerProperty(flowState, 164, 4, "Failed to evaluate Value in Bar widget");
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 169, 3, "Failed to evaluate Hidden flag");
    ...
    {
        const char *new_val = evalTextProperty(flowState, 175, 3, "Failed to evaluate Text in Label widget");
    ...
    {
        const char *new_val = evalTextProperty(flowState, 176, 3, "Failed to evaluate Text in Label widget");
    ...
    {
        int32_t new_val = evalIntegerProperty(flowState, 179, 3, "Failed to evaluate Max in Bar widget");
    ...
    {
        int32_t new_val = evalIntegerProperty(flowState, 179, 4, "Failed to evaluate Value in Bar widget");
    ...
    {
        const char *new_val = evalTextProperty(flowState, 181, 3, "Failed to evaluate Text in Label widget");
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 184, 3, "Failed to evaluate Hidden flag");
    ...
    {
        const char *new_val = evalTextProperty(flowState, 190, 3, "Failed to evaluate Text in Label widget");
    ...
    {
        int32_t new_val = evalIntegerProperty(flowState, 194, 3, "Failed to evaluate Max in Bar widget");
    ...
    {
        int32_t new_val = evalIntegerProperty(flowState, 194, 4, "Failed to evaluate Value in Bar widget");
    ...
    {
        const char *new_val = evalTextProperty(flowState, 196, 3, "Failed to evaluate Text in Label widget");
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 199, 3, "Failed to evaluate Hidden flag");
    ...
    {
        int32_t new_val = evalIntegerProperty(flowState, 208, 3, "Failed to evaluate Max in Bar widget");
        int32_t cur_val = lv_bar_get_max_value(objects.obj226);
        if (new_val != cur_val) {
            int16_t min = lv_bar_get_min_value(objects.obj226);
            int16_t max = new_val;
            if (min < max) {
                lv_bar_set_range(objects.obj226, min, max);
            }
        }
    }
    {
        int32_t new_val = evalIntegerProperty(flowState, 208, 4, "Failed to evaluate Value in Bar widget");
        int32_t cur_val = lv_bar_get_value(objects.obj226);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj226;
            lv_bar_set_value(objects.obj226, new_val, LV_ANIM_OFF);
            tick_value_change_obj = NULL;
        }
    }
    {
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 213, 3, "Failed to evaluate Hidden flag");
    ...
    {
        const char *new_val = evalTextProperty(flowState, 220, 3, "Failed to evaluate Text in Label widget");
    ...
    {
        int32_t new_val = evalIntegerProperty(flowState, 224, 3, "Failed to evaluate Max in Bar widget");
        int32_t cur_val = lv_bar_get_max_value(objects.obj228);
        if (new_val != cur_val) {
            int16_t min = lv_bar_get_min_value(objects.obj228);
            int16_t max = new_val;
            if (min < max) {
                lv_bar_set_range(objects.obj228, min, max);
            }
        }
    }
    {
        int32_t new_val = evalIntegerProperty(flowState, 224, 4, "Failed to evaluate Value in Bar widget");
        int32_t cur_val = lv_bar_get_value(objects.obj228);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj228;
            lv_bar_set_value(objects.obj228, new_val, LV_ANIM_OFF);
            tick_value_change_obj = NULL;
        }
    }
    {
        const char *new_val = evalTextProperty(flowState, 226, 3, "Failed to evaluate Text in Label widget");
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 229, 3, "Failed to evaluate Hidden flag");
    ...
    {
        int32_t new_val = evalIntegerProperty(flowState, 231, 3, "Failed to evaluate Value in Slider widget");
    ...
    {
        const char *new_val = evalTextProperty(flowState, 251, 4, "Failed to evaluate Text in Label widget");
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 251, 3, "Failed to evaluate Hidden flag");
        bool cur_val = lv_obj_has_flag(objects.obj233, LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj233;
            if (new_val) {
                lv_obj_add_flag(objects.obj233, LV_OBJ_FLAG_HIDDEN);
            } else {
                lv_obj_remove_flag(objects.obj233, LV_OBJ_FLAG_HIDDEN);
            }
            tick_value_change_obj = NULL;
        }
    }
    ...
    {
        const char *new_val = evalTextProperty(flowState, 257, 4, "Failed to evaluate Text in Label widget");
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 257, 3, "Failed to evaluate Hidden flag");
        bool cur_val = lv_obj_has_flag(objects.obj238, LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj238;
            if (new_val) {
                lv_obj_add_flag(objects.obj238, LV_OBJ_FLAG_HIDDEN);
            } else {
                lv_obj_remove_flag(objects.obj238, LV_OBJ_FLAG_HIDDEN);
            }
            tick_value_change_obj = NULL;
        }
    }
    ...
    {
        const char *new_val = evalTextProperty(flowState, 263, 4, "Failed to evaluate Text in Label widget");
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 263, 3, "Failed to evaluate Hidden flag");
        bool cur_val = lv_obj_has_flag(objects.obj243, LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj243;
            if (new_val) {
                lv_obj_add_flag(objects.obj243, LV_OBJ_FLAG_HIDDEN);
            } else {
                lv_obj_remove_flag(objects.obj243, LV_OBJ_FLAG_HIDDEN);
            }
            tick_value_change_obj = NULL;
        }
    }
    ...
    {
        const char *new_val = evalTextProperty(flowState, 269, 4, "Failed to evaluate Text in Label widget");
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 269, 3, "Failed to evaluate Hidden flag");
        bool cur_val = lv_obj_has_flag(objects.obj248, LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj248;
            if (new_val) {
                lv_obj_add_flag(objects.obj248, LV_OBJ_FLAG_HIDDEN);
            } else {
                lv_obj_remove_flag(objects.obj248, LV_OBJ_FLAG_HIDDEN);
            }
            tick_value_change_obj = NULL;
        }
    }
    ...
    {
        const char *new_val = evalTextProperty(flowState, 275, 4, "Failed to evaluate Text in Label widget");
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 275, 3, "Failed to evaluate Hidden flag");
        bool cur_val = lv_obj_has_flag(objects.obj253, LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj253;
            if (new_val) {
                lv_obj_add_flag(objects.obj253, LV_OBJ_FLAG_HIDDEN);
            } else {
                lv_obj_remove_flag(objects.obj253, LV_OBJ_FLAG_HIDDEN);
            }
            tick_value_change_obj = NULL;
        }
    }
    ...
    {
        const char *new_val = evalTextProperty(flowState, 281, 4, "Failed to evaluate Text in Label widget");
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 281, 3, "Failed to evaluate Hidden flag");
        bool cur_val = lv_obj_has_flag(objects.obj258, LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj258;
            if (new_val) {
                lv_obj_add_flag(objects.obj258, LV_OBJ_FLAG_HIDDEN);
            } else {
                lv_obj_remove_flag(objects.obj258, LV_OBJ_FLAG_HIDDEN);
            }
            tick_value_change_obj = NULL;
        }
    }
    ...
    {
        const char *new_val = evalTextProperty(flowState, 287, 4, "Failed to evaluate Text in Label widget");
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 287, 3, "Failed to evaluate Hidden flag");
        bool cur_val = lv_obj_has_flag(objects.obj263, LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj263;
            if (new_val) {
                lv_obj_add_flag(objects.obj263, LV_OBJ_FLAG_HIDDEN);
            } else {
                lv_obj_remove_flag(objects.obj263, LV_OBJ_FLAG_HIDDEN);
            }
            tick_value_change_obj = NULL;
        }
    }
    ...
    {
        const char *new_val = evalTextProperty(flowState, 293, 4, "Failed to evaluate Text in Label widget");
    ...
    {
        bool new_val = evalBooleanProperty(flowState, 293, 3, "Failed to evaluate Hidden flag");
        bool cur_val = lv_obj_has_flag(objects.obj268, LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj268;
            if (new_val) {
                lv_obj_add_flag(objects.obj268, LV_OBJ_FLAG_HIDDEN);
            } else {
                lv_obj_remove_flag(objects.obj268, LV_OBJ_FLAG_HIDDEN);
            }
            tick_value_change_obj = NULL;
        }
    }
    ...
    {
        const char *new_val = evalTextProperty(flowState, 298, 3, "Failed to evaluate Text in Label widget");
        const char *cur_val = lv_label_get_text(objects.obj272);
        if (strcmp(new_val, cur_val) != 0) {
            tick_value_change_obj = objects.obj272;
            lv_label_set_text(objects.obj272, new_val);
            tick_value_change_obj = NULL;
        }
    }
    {
        const char *new_val = evalTextProperty(flowState, 299, 4, "Failed to evaluate Text in Label widget");
        const char *cur_val = lv_label_get_text(objects.obj273);
        if (strcmp(new_val, cur_val) != 0) {
            tick_value_change_obj = objects.obj273;
            lv_label_set_text(objects.obj273, new_val);
            tick_value_change_obj = NULL;
        }
    }
    {
        bool new_val = evalBooleanProperty(flowState, 299, 3, "Failed to evaluate Hidden flag");
        bool cur_val = lv_obj_has_flag(objects.obj273, LV_OBJ_FLAG_HIDDEN);
        if (new_val != cur_val) {
            tick_value_change_obj = objects.obj273;
            if (new_val) {
                lv_obj_add_flag(objects.obj273, LV_OBJ_FLAG_HIDDEN);
            } else {
                lv_obj_remove_flag(objects.obj273, LV_OBJ_FLAG_HIDDEN);
            }
            tick_value_change_obj = NULL;
        }
    }
    {
        const char *new_val = evalTextProperty(flowState, 300, 3, "Failed to evaluate Text in Label widget");
        const char *cur_val = lv_label_get_text(objects.obj274);
        if (strcmp(new_val, cur_val) != 0) {
            tick_value_change_obj = objects.obj274;
            lv_label_set_text(objects.obj274, new_val);
            tick_value_change_obj = NULL;
        }
    }
    {
        bool new_val = evalBooleanProperty(flowState, 305, 3, "Failed to evaluate Hidden flag");
    ...
    {
        const char *new_val = evalTextProperty(flowState, 380, 3, "Failed to evaluate Text in Label widget");
    ...
    {
        const char *new_val = evalTextProperty(flowState, 381, 3, "Failed to evaluate Text in Label widget");
