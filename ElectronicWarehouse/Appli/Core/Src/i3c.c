...
void MX_I3C2_Init(void)
{
  ...
  hi3c2.Init.CtrlBusCharacteristic.SCLPPLowDuration = 0x9e;
  hi3c2.Init.CtrlBusCharacteristic.SCLI3CHighDuration = 0x00;
  hi3c2.Init.CtrlBusCharacteristic.SCLODLowDuration = 0x6f;
  hi3c2.Init.CtrlBusCharacteristic.SCLI2CHighDuration = 0x2f;
  hi3c2.Init.CtrlBusCharacteristic.BusFreeDuration = 0x3b;
