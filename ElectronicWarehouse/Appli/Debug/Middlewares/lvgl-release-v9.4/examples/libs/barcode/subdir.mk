...
C_SRCS += \
../Middlewares/lvgl-release-v9.4/examples/libs/barcode/lv_example_barcode_1.c 

C_DEPS += \
./Middlewares/lvgl-release-v9.4/examples/libs/barcode/lv_example_barcode_1.d 

OBJS += \
./Middlewares/lvgl-release-v9.4/examples/libs/barcode/lv_example_barcode_1.o 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/lvgl-release-v9.4/examples/libs/barcode/%.o Middlewares/lvgl-release-v9.4/examples/libs/barcode/%.su Middlewares/lvgl-release-v9.4/examples/libs/barcode/%.cyclo: ../Middlewares/lvgl-release-v9.4/examples/libs/barcode/%.c Middlewares/lvgl-release-v9.4/examples/libs/barcode/subdir.mk
...
clean: clean-Middlewares-2f-lvgl-2d-release-2d-v9-2e-4-2f-examples-2f-libs-2f-barcode

clean-Middlewares-2f-lvgl-2d-release-2d-v9-2e-4-2f-examples-2f-libs-2f-barcode:
	-$(RM) ./Middlewares/lvgl-release-v9.4/examples/libs/barcode/lv_example_barcode_1.cyclo ./Middlewares/lvgl-release-v9.4/examples/libs/barcode/lv_example_barcode_1.d ./Middlewares/lvgl-release-v9.4/examples/libs/barcode/lv_example_barcode_1.o ./Middlewares/lvgl-release-v9.4/examples/libs/barcode/lv_example_barcode_1.su

.PHONY: clean-Middlewares-2f-lvgl-2d-release-2d-v9-2e-4-2f-examples-2f-libs-2f-barcode
