...
C_SRCS += \
../Middlewares/lvgl-release-v9.4/examples/libs/gif/img_bulb_gif.c \
../Middlewares/lvgl-release-v9.4/examples/libs/gif/lv_example_gif_1.c 

C_DEPS += \
./Middlewares/lvgl-release-v9.4/examples/libs/gif/img_bulb_gif.d \
./Middlewares/lvgl-release-v9.4/examples/libs/gif/lv_example_gif_1.d 

OBJS += \
./Middlewares/lvgl-release-v9.4/examples/libs/gif/img_bulb_gif.o \
./Middlewares/lvgl-release-v9.4/examples/libs/gif/lv_example_gif_1.o 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/lvgl-release-v9.4/examples/libs/gif/%.o Middlewares/lvgl-release-v9.4/examples/libs/gif/%.su Middlewares/lvgl-release-v9.4/examples/libs/gif/%.cyclo: ../Middlewares/lvgl-release-v9.4/examples/libs/gif/%.c Middlewares/lvgl-release-v9.4/examples/libs/gif/subdir.mk
...
clean: clean-Middlewares-2f-lvgl-2d-release-2d-v9-2e-4-2f-examples-2f-libs-2f-gif

clean-Middlewares-2f-lvgl-2d-release-2d-v9-2e-4-2f-examples-2f-libs-2f-gif:
	-$(RM) ./Middlewares/lvgl-release-v9.4/examples/libs/gif/img_bulb_gif.cyclo ./Middlewares/lvgl-release-v9.4/examples/libs/gif/img_bulb_gif.d ./Middlewares/lvgl-release-v9.4/examples/libs/gif/img_bulb_gif.o ./Middlewares/lvgl-release-v9.4/examples/libs/gif/img_bulb_gif.su ./Middlewares/lvgl-release-v9.4/examples/libs/gif/lv_example_gif_1.cyclo ./Middlewares/lvgl-release-v9.4/examples/libs/gif/lv_example_gif_1.d ./Middlewares/lvgl-release-v9.4/examples/libs/gif/lv_example_gif_1.o ./Middlewares/lvgl-release-v9.4/examples/libs/gif/lv_example_gif_1.su

.PHONY: clean-Middlewares-2f-lvgl-2d-release-2d-v9-2e-4-2f-examples-2f-libs-2f-gif
