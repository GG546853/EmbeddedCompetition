...
C_SRCS += \
../Middlewares/lvgl-release-v9.4/examples/libs/gltf/lv_example_gltf_1.c \
../Middlewares/lvgl-release-v9.4/examples/libs/gltf/lv_example_gltf_2.c 

C_DEPS += \
./Middlewares/lvgl-release-v9.4/examples/libs/gltf/lv_example_gltf_1.d \
./Middlewares/lvgl-release-v9.4/examples/libs/gltf/lv_example_gltf_2.d 

OBJS += \
./Middlewares/lvgl-release-v9.4/examples/libs/gltf/lv_example_gltf_1.o \
./Middlewares/lvgl-release-v9.4/examples/libs/gltf/lv_example_gltf_2.o 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/lvgl-release-v9.4/examples/libs/gltf/%.o Middlewares/lvgl-release-v9.4/examples/libs/gltf/%.su Middlewares/lvgl-release-v9.4/examples/libs/gltf/%.cyclo: ../Middlewares/lvgl-release-v9.4/examples/libs/gltf/%.c Middlewares/lvgl-release-v9.4/examples/libs/gltf/subdir.mk
