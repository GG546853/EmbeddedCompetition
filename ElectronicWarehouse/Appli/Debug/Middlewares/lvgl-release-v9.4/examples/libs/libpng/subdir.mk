...
C_SRCS += \
../Middlewares/lvgl-release-v9.4/examples/libs/libpng/img_png_demo.c \
../Middlewares/lvgl-release-v9.4/examples/libs/libpng/lv_example_libpng_1.c 

C_DEPS += \
./Middlewares/lvgl-release-v9.4/examples/libs/libpng/img_png_demo.d \
./Middlewares/lvgl-release-v9.4/examples/libs/libpng/lv_example_libpng_1.d 

OBJS += \
./Middlewares/lvgl-release-v9.4/examples/libs/libpng/img_png_demo.o \
./Middlewares/lvgl-release-v9.4/examples/libs/libpng/lv_example_libpng_1.o 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/lvgl-release-v9.4/examples/libs/libpng/%.o Middlewares/lvgl-release-v9.4/examples/libs/libpng/%.su Middlewares/lvgl-release-v9.4/examples/libs/libpng/%.cyclo: ../Middlewares/lvgl-release-v9.4/examples/libs/libpng/%.c Middlewares/lvgl-release-v9.4/examples/libs/libpng/subdir.mk
...
clean: clean-Middlewares-2f-lvgl-2d-release-2d-v9-2e-4-2f-examples-2f-libs-2f-libpng

clean-Middlewares-2f-lvgl-2d-release-2d-v9-2e-4-2f-examples-2f-libs-2f-libpng:
	-$(RM) ./Middlewares/lvgl-release-v9.4/examples/libs/libpng/img_png_demo.cyclo ./Middlewares/lvgl-release-v9.4/examples/libs/libpng/img_png_demo.d ./Middlewares/lvgl-release-v9.4/examples/libs/libpng/img_png_demo.o ./Middlewares/lvgl-release-v9.4/examples/libs/libpng/img_png_demo.su ./Middlewares/lvgl-release-v9.4/examples/libs/libpng/lv_example_libpng_1.cyclo ./Middlewares/lvgl-release-v9.4/examples/libs/libpng/lv_example_libpng_1.d ./Middlewares/lvgl-release-v9.4/examples/libs/libpng/lv_example_libpng_1.o ./Middlewares/lvgl-release-v9.4/examples/libs/libpng/lv_example_libpng_1.su

.PHONY: clean-Middlewares-2f-lvgl-2d-release-2d-v9-2e-4-2f-examples-2f-libs-2f-libpng
