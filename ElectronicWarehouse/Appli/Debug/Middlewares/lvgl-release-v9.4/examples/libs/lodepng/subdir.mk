...
C_SRCS += \
../Middlewares/lvgl-release-v9.4/examples/libs/lodepng/img_wink_png.c \
../Middlewares/lvgl-release-v9.4/examples/libs/lodepng/lv_example_lodepng_1.c 

C_DEPS += \
./Middlewares/lvgl-release-v9.4/examples/libs/lodepng/img_wink_png.d \
./Middlewares/lvgl-release-v9.4/examples/libs/lodepng/lv_example_lodepng_1.d 

OBJS += \
./Middlewares/lvgl-release-v9.4/examples/libs/lodepng/img_wink_png.o \
./Middlewares/lvgl-release-v9.4/examples/libs/lodepng/lv_example_lodepng_1.o 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/lvgl-release-v9.4/examples/libs/lodepng/%.o Middlewares/lvgl-release-v9.4/examples/libs/lodepng/%.su Middlewares/lvgl-release-v9.4/examples/libs/lodepng/%.cyclo: ../Middlewares/lvgl-release-v9.4/examples/libs/lodepng/%.c Middlewares/lvgl-release-v9.4/examples/libs/lodepng/subdir.mk
...
clean: clean-Middlewares-2f-lvgl-2d-release-2d-v9-2e-4-2f-examples-2f-libs-2f-lodepng

clean-Middlewares-2f-lvgl-2d-release-2d-v9-2e-4-2f-examples-2f-libs-2f-lodepng:
	-$(RM) ./Middlewares/lvgl-release-v9.4/examples/libs/lodepng/img_wink_png.cyclo ./Middlewares/lvgl-release-v9.4/examples/libs/lodepng/img_wink_png.d ./Middlewares/lvgl-release-v9.4/examples/libs/lodepng/img_wink_png.o ./Middlewares/lvgl-release-v9.4/examples/libs/lodepng/img_wink_png.su ./Middlewares/lvgl-release-v9.4/examples/libs/lodepng/lv_example_lodepng_1.cyclo ./Middlewares/lvgl-release-v9.4/examples/libs/lodepng/lv_example_lodepng_1.d ./Middlewares/lvgl-release-v9.4/examples/libs/lodepng/lv_example_lodepng_1.o ./Middlewares/lvgl-release-v9.4/examples/libs/lodepng/lv_example_lodepng_1.su

.PHONY: clean-Middlewares-2f-lvgl-2d-release-2d-v9-2e-4-2f-examples-2f-libs-2f-lodepng
