...
C_SRCS += \
../Middlewares/lvgl-release-v9.4/examples/libs/qrcode/lv_example_qrcode_1.c 

C_DEPS += \
./Middlewares/lvgl-release-v9.4/examples/libs/qrcode/lv_example_qrcode_1.d 

OBJS += \
./Middlewares/lvgl-release-v9.4/examples/libs/qrcode/lv_example_qrcode_1.o 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/lvgl-release-v9.4/examples/libs/qrcode/%.o Middlewares/lvgl-release-v9.4/examples/libs/qrcode/%.su Middlewares/lvgl-release-v9.4/examples/libs/qrcode/%.cyclo: ../Middlewares/lvgl-release-v9.4/examples/libs/qrcode/%.c Middlewares/lvgl-release-v9.4/examples/libs/qrcode/subdir.mk
...
clean: clean-Middlewares-2f-lvgl-2d-release-2d-v9-2e-4-2f-examples-2f-libs-2f-qrcode

clean-Middlewares-2f-lvgl-2d-release-2d-v9-2e-4-2f-examples-2f-libs-2f-qrcode:
	-$(RM) ./Middlewares/lvgl-release-v9.4/examples/libs/qrcode/lv_example_qrcode_1.cyclo ./Middlewares/lvgl-release-v9.4/examples/libs/qrcode/lv_example_qrcode_1.d ./Middlewares/lvgl-release-v9.4/examples/libs/qrcode/lv_example_qrcode_1.o ./Middlewares/lvgl-release-v9.4/examples/libs/qrcode/lv_example_qrcode_1.su

.PHONY: clean-Middlewares-2f-lvgl-2d-release-2d-v9-2e-4-2f-examples-2f-libs-2f-qrcode
