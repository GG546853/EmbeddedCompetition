...
C_SRCS += \
../Middlewares/lvgl-release-v9.4/examples/libs/svg/lv_example_svg_1.c \
../Middlewares/lvgl-release-v9.4/examples/libs/svg/lv_example_svg_2.c \
../Middlewares/lvgl-release-v9.4/examples/libs/svg/lv_example_svg_3.c 

C_DEPS += \
./Middlewares/lvgl-release-v9.4/examples/libs/svg/lv_example_svg_1.d \
./Middlewares/lvgl-release-v9.4/examples/libs/svg/lv_example_svg_2.d \
./Middlewares/lvgl-release-v9.4/examples/libs/svg/lv_example_svg_3.d 

OBJS += \
./Middlewares/lvgl-release-v9.4/examples/libs/svg/lv_example_svg_1.o \
./Middlewares/lvgl-release-v9.4/examples/libs/svg/lv_example_svg_2.o \
./Middlewares/lvgl-release-v9.4/examples/libs/svg/lv_example_svg_3.o 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/lvgl-release-v9.4/examples/libs/svg/%.o Middlewares/lvgl-release-v9.4/examples/libs/svg/%.su Middlewares/lvgl-release-v9.4/examples/libs/svg/%.cyclo: ../Middlewares/lvgl-release-v9.4/examples/libs/svg/%.c Middlewares/lvgl-release-v9.4/examples/libs/svg/subdir.mk
...
clean: clean-Middlewares-2f-lvgl-2d-release-2d-v9-2e-4-2f-examples-2f-libs-2f-svg

clean-Middlewares-2f-lvgl-2d-release-2d-v9-2e-4-2f-examples-2f-libs-2f-svg:
	-$(RM) ./Middlewares/lvgl-release-v9.4/examples/libs/svg/lv_example_svg_1.cyclo ./Middlewares/lvgl-release-v9.4/examples/libs/svg/lv_example_svg_1.d ./Middlewares/lvgl-release-v9.4/examples/libs/svg/lv_example_svg_1.o ./Middlewares/lvgl-release-v9.4/examples/libs/svg/lv_example_svg_1.su ./Middlewares/lvgl-release-v9.4/examples/libs/svg/lv_example_svg_2.cyclo ./Middlewares/lvgl-release-v9.4/examples/libs/svg/lv_example_svg_2.d ./Middlewares/lvgl-release-v9.4/examples/libs/svg/lv_example_svg_2.o ./Middlewares/lvgl-release-v9.4/examples/libs/svg/lv_example_svg_2.su ./Middlewares/lvgl-release-v9.4/examples/libs/svg/lv_example_svg_3.cyclo ./Middlewares/lvgl-release-v9.4/examples/libs/svg/lv_example_svg_3.d ./Middlewares/lvgl-release-v9.4/examples/libs/svg/lv_example_svg_3.o ./Middlewares/lvgl-release-v9.4/examples/libs/svg/lv_example_svg_3.su

.PHONY: clean-Middlewares-2f-lvgl-2d-release-2d-v9-2e-4-2f-examples-2f-libs-2f-svg
