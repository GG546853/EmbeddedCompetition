...
C_SRCS += \
../Middlewares/lvgl-release-v9.4/examples/libs/tjpgd/lv_example_tjpgd_1.c 

C_DEPS += \
./Middlewares/lvgl-release-v9.4/examples/libs/tjpgd/lv_example_tjpgd_1.d 

OBJS += \
./Middlewares/lvgl-release-v9.4/examples/libs/tjpgd/lv_example_tjpgd_1.o 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/lvgl-release-v9.4/examples/libs/tjpgd/%.o Middlewares/lvgl-release-v9.4/examples/libs/tjpgd/%.su Middlewares/lvgl-release-v9.4/examples/libs/tjpgd/%.cyclo: ../Middlewares/lvgl-release-v9.4/examples/libs/tjpgd/%.c Middlewares/lvgl-release-v9.4/examples/libs/tjpgd/subdir.mk
...
clean: clean-Middlewares-2f-lvgl-2d-release-2d-v9-2e-4-2f-examples-2f-libs-2f-tjpgd

clean-Middlewares-2f-lvgl-2d-release-2d-v9-2e-4-2f-examples-2f-libs-2f-tjpgd:
	-$(RM) ./Middlewares/lvgl-release-v9.4/examples/libs/tjpgd/lv_example_tjpgd_1.cyclo ./Middlewares/lvgl-release-v9.4/examples/libs/tjpgd/lv_example_tjpgd_1.d ./Middlewares/lvgl-release-v9.4/examples/libs/tjpgd/lv_example_tjpgd_1.o ./Middlewares/lvgl-release-v9.4/examples/libs/tjpgd/lv_example_tjpgd_1.su

.PHONY: clean-Middlewares-2f-lvgl-2d-release-2d-v9-2e-4-2f-examples-2f-libs-2f-tjpgd
