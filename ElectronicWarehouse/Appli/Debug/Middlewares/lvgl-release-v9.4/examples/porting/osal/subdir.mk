...
C_SRCS += \
../Middlewares/lvgl-release-v9.4/examples/porting/osal/lv_example_osal.c 

C_DEPS += \
./Middlewares/lvgl-release-v9.4/examples/porting/osal/lv_example_osal.d 

OBJS += \
./Middlewares/lvgl-release-v9.4/examples/porting/osal/lv_example_osal.o 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/lvgl-release-v9.4/examples/porting/osal/%.o Middlewares/lvgl-release-v9.4/examples/porting/osal/%.su Middlewares/lvgl-release-v9.4/examples/porting/osal/%.cyclo: ../Middlewares/lvgl-release-v9.4/examples/porting/osal/%.c Middlewares/lvgl-release-v9.4/examples/porting/osal/subdir.mk
...
clean: clean-Middlewares-2f-lvgl-2d-release-2d-v9-2e-4-2f-examples-2f-porting-2f-osal

clean-Middlewares-2f-lvgl-2d-release-2d-v9-2e-4-2f-examples-2f-porting-2f-osal:
	-$(RM) ./Middlewares/lvgl-release-v9.4/examples/porting/osal/lv_example_osal.cyclo ./Middlewares/lvgl-release-v9.4/examples/porting/osal/lv_example_osal.d ./Middlewares/lvgl-release-v9.4/examples/porting/osal/lv_example_osal.o ./Middlewares/lvgl-release-v9.4/examples/porting/osal/lv_example_osal.su

.PHONY: clean-Middlewares-2f-lvgl-2d-release-2d-v9-2e-4-2f-examples-2f-porting-2f-osal
