...
C_SRCS += \
../Middlewares/lvgl-release-v9.4/src/layouts/flex/lv_flex.c 

C_DEPS += \
./Middlewares/lvgl-release-v9.4/src/layouts/flex/lv_flex.d 

OBJS += \
./Middlewares/lvgl-release-v9.4/src/layouts/flex/lv_flex.o 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/lvgl-release-v9.4/src/layouts/flex/%.o Middlewares/lvgl-release-v9.4/src/layouts/flex/%.su Middlewares/lvgl-release-v9.4/src/layouts/flex/%.cyclo: ../Middlewares/lvgl-release-v9.4/src/layouts/flex/%.c Middlewares/lvgl-release-v9.4/src/layouts/flex/subdir.mk
...
clean: clean-Middlewares-2f-lvgl-2d-release-2d-v9-2e-4-2f-src-2f-layouts-2f-flex

clean-Middlewares-2f-lvgl-2d-release-2d-v9-2e-4-2f-src-2f-layouts-2f-flex:
	-$(RM) ./Middlewares/lvgl-release-v9.4/src/layouts/flex/lv_flex.cyclo ./Middlewares/lvgl-release-v9.4/src/layouts/flex/lv_flex.d ./Middlewares/lvgl-release-v9.4/src/layouts/flex/lv_flex.o ./Middlewares/lvgl-release-v9.4/src/layouts/flex/lv_flex.su

.PHONY: clean-Middlewares-2f-lvgl-2d-release-2d-v9-2e-4-2f-src-2f-layouts-2f-flex
