...
C_SRCS += \
../Middlewares/lvgl-release-v9.4/src/layouts/grid/lv_grid.c 

C_DEPS += \
./Middlewares/lvgl-release-v9.4/src/layouts/grid/lv_grid.d 

OBJS += \
./Middlewares/lvgl-release-v9.4/src/layouts/grid/lv_grid.o 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/lvgl-release-v9.4/src/layouts/grid/%.o Middlewares/lvgl-release-v9.4/src/layouts/grid/%.su Middlewares/lvgl-release-v9.4/src/layouts/grid/%.cyclo: ../Middlewares/lvgl-release-v9.4/src/layouts/grid/%.c Middlewares/lvgl-release-v9.4/src/layouts/grid/subdir.mk
...
clean: clean-Middlewares-2f-lvgl-2d-release-2d-v9-2e-4-2f-src-2f-layouts-2f-grid

clean-Middlewares-2f-lvgl-2d-release-2d-v9-2e-4-2f-src-2f-layouts-2f-grid:
	-$(RM) ./Middlewares/lvgl-release-v9.4/src/layouts/grid/lv_grid.cyclo ./Middlewares/lvgl-release-v9.4/src/layouts/grid/lv_grid.d ./Middlewares/lvgl-release-v9.4/src/layouts/grid/lv_grid.o ./Middlewares/lvgl-release-v9.4/src/layouts/grid/lv_grid.su

.PHONY: clean-Middlewares-2f-lvgl-2d-release-2d-v9-2e-4-2f-src-2f-layouts-2f-grid
