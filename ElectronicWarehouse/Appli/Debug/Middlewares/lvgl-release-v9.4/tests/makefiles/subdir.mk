...
C_SRCS += \
../Middlewares/lvgl-release-v9.4/tests/makefiles/test.c 

OBJS += \
./Middlewares/lvgl-release-v9.4/tests/makefiles/test.o 

C_DEPS += \
./Middlewares/lvgl-release-v9.4/tests/makefiles/test.d 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/lvgl-release-v9.4/tests/makefiles/%.o Middlewares/lvgl-release-v9.4/tests/makefiles/%.su Middlewares/lvgl-release-v9.4/tests/makefiles/%.cyclo: ../Middlewares/lvgl-release-v9.4/tests/makefiles/%.c Middlewares/lvgl-release-v9.4/tests/makefiles/subdir.mk
...
clean: clean-Middlewares-2f-lvgl-2d-release-2d-v9-2e-4-2f-tests-2f-makefiles

clean-Middlewares-2f-lvgl-2d-release-2d-v9-2e-4-2f-tests-2f-makefiles:
	-$(RM) ./Middlewares/lvgl-release-v9.4/tests/makefiles/test.cyclo ./Middlewares/lvgl-release-v9.4/tests/makefiles/test.d ./Middlewares/lvgl-release-v9.4/tests/makefiles/test.o ./Middlewares/lvgl-release-v9.4/tests/makefiles/test.su

.PHONY: clean-Middlewares-2f-lvgl-2d-release-2d-v9-2e-4-2f-tests-2f-makefiles
