...
C_SRCS += \
../Middlewares/lvgl-release-v9.4/tests/makefiles_uefi/test.c 

OBJS += \
./Middlewares/lvgl-release-v9.4/tests/makefiles_uefi/test.o 

C_DEPS += \
./Middlewares/lvgl-release-v9.4/tests/makefiles_uefi/test.d 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/lvgl-release-v9.4/tests/makefiles_uefi/%.o Middlewares/lvgl-release-v9.4/tests/makefiles_uefi/%.su Middlewares/lvgl-release-v9.4/tests/makefiles_uefi/%.cyclo: ../Middlewares/lvgl-release-v9.4/tests/makefiles_uefi/%.c Middlewares/lvgl-release-v9.4/tests/makefiles_uefi/subdir.mk
...
clean: clean-Middlewares-2f-lvgl-2d-release-2d-v9-2e-4-2f-tests-2f-makefiles_uefi

clean-Middlewares-2f-lvgl-2d-release-2d-v9-2e-4-2f-tests-2f-makefiles_uefi:
	-$(RM) ./Middlewares/lvgl-release-v9.4/tests/makefiles_uefi/test.cyclo ./Middlewares/lvgl-release-v9.4/tests/makefiles_uefi/test.d ./Middlewares/lvgl-release-v9.4/tests/makefiles_uefi/test.o ./Middlewares/lvgl-release-v9.4/tests/makefiles_uefi/test.su

.PHONY: clean-Middlewares-2f-lvgl-2d-release-2d-v9-2e-4-2f-tests-2f-makefiles_uefi
