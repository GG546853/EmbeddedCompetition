...
C_SRCS += \
../Middlewares/lvgl-release-v9.4/tests/unity/unity.c 

OBJS += \
./Middlewares/lvgl-release-v9.4/tests/unity/unity.o 

C_DEPS += \
./Middlewares/lvgl-release-v9.4/tests/unity/unity.d 


# Each subdirectory must supply rules for building sources it contributes
Middlewares/lvgl-release-v9.4/tests/unity/%.o Middlewares/lvgl-release-v9.4/tests/unity/%.su Middlewares/lvgl-release-v9.4/tests/unity/%.cyclo: ../Middlewares/lvgl-release-v9.4/tests/unity/%.c Middlewares/lvgl-release-v9.4/tests/unity/subdir.mk
...
clean: clean-Middlewares-2f-lvgl-2d-release-2d-v9-2e-4-2f-tests-2f-unity

clean-Middlewares-2f-lvgl-2d-release-2d-v9-2e-4-2f-tests-2f-unity:
	-$(RM) ./Middlewares/lvgl-release-v9.4/tests/unity/unity.cyclo ./Middlewares/lvgl-release-v9.4/tests/unity/unity.d ./Middlewares/lvgl-release-v9.4/tests/unity/unity.o ./Middlewares/lvgl-release-v9.4/tests/unity/unity.su

.PHONY: clean-Middlewares-2f-lvgl-2d-release-2d-v9-2e-4-2f-tests-2f-unity
